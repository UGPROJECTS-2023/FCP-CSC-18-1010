    ...
    <div class="card shadow mb-3">
        ...
        <div class="card-body">
        	<form action="<?php echo site_url('report/addreport') ?>" method="post" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                    <label for="nik">Candidate ID*</label>
                    <input class="form-control"
                     name="nik" placeholder="Enter Candidate ID" value="<?= set_value('nik'); ?>">
                    <?= form_error('nik', '<small class="text-danger pl-3">', '</small>'); ?>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="rt">Candidate Level</label>
                            <input class="form-control"
                            type="number" name="rt" placeholder="Enter Candidate Level" value="<?= set_value('rt'); ?>">
                            <?= form_error('rt', '<small class="text-danger pl-3">', '</small>'); ?>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="rw">Date</label>
                            <input class="form-control"
                             name="rw" placeholder="Enter Date" value="<?= set_value('rw'); ?>">
                            <?= form_error('rw', '<small class="text-danger pl-3">', '</small>'); ?>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="village">Lecturer Involved*</label>
                            <input class="form-control"
                            type="text" name="village" placeholder="Lecturer Involved" value="<?= set_value('village'); ?>">
